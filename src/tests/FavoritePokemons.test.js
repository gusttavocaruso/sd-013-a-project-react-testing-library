...
describe('Verifica o component FavoritePokemons', () => {
  it(`Verifica se é exibido na tela a mensagem
  ...
  // https://github.com/tryber/sd-013-a-project-react-testing-library/pull/48/files Fonte: Fernando Costa
