...
describe('Tests for the FavoritePokemons.js component', () => {
  it('Checks if theres a message with the text "No favorite pokemon found"', () => {
    renderWithRouter(<FavoritePokemons />);
    // Finds the "P" element with the desired text, by using the RegExp method (/string/i), and providing this information to a new const through a screen.getByText method to better organize the structure of the code.
